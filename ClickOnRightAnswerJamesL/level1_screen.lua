...
function scene:create( event )
    ...
    addEquationTextObject = display.newText( "", display.contentWidth*1/4, display.contentHeight*2/5, nil, 60 )
    ...
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.2, display.contentHeight/2, nil, 60 )
    ...
    -- create the text object that will say Incrrect, set the colour and then hide it
